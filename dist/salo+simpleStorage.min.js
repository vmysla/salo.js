...
function B(d,g){function u(){}function m(){n=k=0;d.set("buildHitTask",A);d.set("sendHitTask",x)}function t(a){d.set("buildHitTask",e);d.set("sendHitTask",x);a&&d.send("exception",{exDescription:"[salo.js] "+a.message,nonInteraction:!0,exFatal:!1})}function p(a){for(var c,d=!1,y=l.length;!d&&y--;){c=l[y];var d=!0,e;for(e in c)a.get(e)!=c[e]&&(d=!1)}return d?(c="salo"+(new h.Date).getTime(),a=a.get("hitPayload"),f.set(c,a,{b:b})&&c):!1}function q(){if(!(0<n))for(var a=f.index(),b=0;b<a.length;){var c=
