...
function E(u,d){function y(){}function g(a){u.set("sendHitTask",a||r)}function n(a,b){g(C);return a&&u.send("exception",{exDescription:"salo.js - "+b+":"+a.message,nonInteraction:!0,exFatal:!1})}function l(c,d){d||(e++,d=a(c)&&v(c));if(!d||!f&&q(d)){var x=w.setTimeout(function(){x=x&&t(!1)},h),A=c.get("hitCallback")||y;c.set("hitCallback",function F(){try{x&&(x=w.clearTimeout(x));if(d){var a=d;k.f(a);k.f(a+"lock")}A&&(t(!0),A())}catch(c){n(c,F)}A=b},!0);e--;f++;C(c)}}function t(a){f--;return a&&m()||
w.setTimeout(m,h)}function r(a,b){try{l(a,b)}catch(c){n(c,r)}}function a(a){for(var b,c=!1,d=p.length;!c&&d--;){b=p[d];var c=!0,e;for(e in b)a.get(e)!=b[e]&&(c=!1)}return c&&b}function v(a){var b="hit"+(new w.Date).getTime();a=a.get("hitPayload");return k.set(b,a,{b:D})&&b}function m(){if(!(0<f))for(var a=k.index(),b=0;b<a.length;){var c=a[b++],d=c.match(/^hit(\d+)$/);if(d){var d=parseInt(d[1],10),d=(new w.Date).getTime()-d,e=k.get(c);r(B({transport:G,transportUrl:H,hitPayload:e+"&qt="+d}),c)}}}function q(a){a+=
"lock";if(k.get(a))return!1;k.set(a,1,{b:h});return!0}function B(a){return{get:function(b){return a[b]},set:function(b,c){a[b]=c}}}var b,c={enable:g,disable:n,watch:function(a){p.push(a)}},p=[{useSalo:!0,useBeacon:!1,hitCallback:b,transport:b}],e=0,f=0;d=d||{};var D=d.storageTimeout||108E5,h=d.transportTimeout||5E3,G=d.transportMethod||"image",H=d.transportUrl||"//www.google-analytics.com/collect",w=d.timing||window,k=d.storage||window.simpleStorage,C=u.get("sendHitTask");g();return c}
"undefined"!==typeof exports&&(module.g=E);